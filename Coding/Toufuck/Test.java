...
public class Test {
	...
	public static void main(String[] args) {
		...
		for(Product g:i) {
			if(g.getClass().getName()=="assignment_spring2020.Game") {
		...
		for(Product g:i) {
			if(g.getClass().getName()=="assignment_spring2020.Music") {
				s.add(g.getPrice());
			}
		}
		for(Product g:i) {
		...
		System.out.println("All movies directed by Francis Ford Coppola\n");
			for(Product g:i) {
				...
				Movie m=(Movie)g;
				if(g.getClass().getName()=="assignment_spring2020.Movie") {
		...
		System.out.println(n1.numberOfItemsStockedOfEachSoldProduct());
