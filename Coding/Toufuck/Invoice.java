...
public class Invoice {
	...
	//numberOfItemsStocked of each sold product
	public String numberOfItemsStockedOfEachSoldProduct() {
		String j="";
		for(Product product:items) {
			if(product instanceof StockableProduct) {
				StockableProduct stockableproduct=(StockableProduct)product;
				if(product.getClass().getName()=="assignment_spring2020.Movie") {
					
					String a="Name: "+product.getName()+", Catagory: Movie "+",Items: "+stockableproduct.getNumberOfStockItem()+"\n";
					j=j+a;
				}
				if(product.getClass().getName()=="assignment_spring2020.Music") {
					String a="Name: "+product.getName()+", Catagory: Music "+",Items: "+stockableproduct.getNumberOfStockItem()+"\n";
					j=j+a;
				}
				if(product.getClass().getName()=="assignment_spring2020.Game") {
					String a="Name: "+product.getName()+", Catagory: Game,"+" Items: "+stockableproduct.getNumberOfStockItem()+"\n";
					j=j+a;
				}
